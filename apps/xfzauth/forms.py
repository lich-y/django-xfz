...
class LoginForm(forms.Form, FormMixin):
    ...
    password = forms.CharField(max_length=15, min_length=6,
                               error_messages={"max_length": "密码最多不能超过15个字符",
...
class RegisterForm(forms.Form, FormMixin):
    ...
    password1 = forms.CharField(max_length=15, min_length=6,
                                error_messages={"max_length": "密码最多不能超过15个字符",
                                                "min_length": "密码最少不能少于6个字符"})
    ...
    def clean(self):
        ...
        if not sms_captcha or cached_sms_captcha.lower() != sms_captcha.lower():
